...
# boxplots for blood pressure distributions by each assessment and final decision
boxplot(
...
# histograms for overall distributions of Frequency and Blood Pressure
hist(
  df_hosp$Frequency,
...
# blog link: https://morganlefey.com/assignment-4-lis4370/
